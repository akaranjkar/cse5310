    ...
    public static class SentimentMapper
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (!tweet.equals("") && !tweet.equals("text")
                    && !fields[3].equals("") && !fields[3].equals("retweets")) {
                String senti = sdc.analyze(tweet).toString();
                word.set(senti);
                retweets.set(Long.parseLong(fields[3]));
                context.write(word, retweets);
            }
        }
